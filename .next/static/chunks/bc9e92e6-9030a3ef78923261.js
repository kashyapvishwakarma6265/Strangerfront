"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{9978:function(e,t,r){r.d(t,{JU:function(){return ic},QT:function(){return iG},ad:function(){return ig},pl:function(){return iH},r7:function(){return iW}});var n,i,s=r(3991),a=r(5538),o=r(6914),l=r(8745),u=r(613);r(2601);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iG(e){e=is(e,iu);let t=is(e.firestore,im);return(function(e,t,r={}){let n=new T;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new n4({next:s=>{t.enqueueAndForget(()=>nA(e,a));let o=s.docs.has(r);!o&&s.fromCache?i.reject(new _(E.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&n&&"server"===n.source?i.reject(new _(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new nD(new eZ(r.path),s,{includeMetadataChanges:!0,J_:!0});return nS(e,a)})(await n7(e),e.asyncQueue,t,r,n)),n.promise})(ip(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new ij(e);return new iK(e,i,t._key,n,new i$(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class ij extends iz{constructor(e){super(),this.firestore=e}convertBytes(e){return new iw(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iu(this.firestore,null,t)}}function iH(e,t,r){var n;e=is(e,iu);let i=is(e.firestore,im),s=(n=e.converter)?r&&(r.merge||r.mergeFields)?n.toFirestore(t,r):n.toFirestore(t):t;return iY(i,[(function(e,t,r,n,i,s={}){let a,o;let l=e.pu(s.merge||s.mergeFields?2:0,t,r,i);iL("Data must be an object, but it was:",l,n);let u=iR(n,l);if(s.merge)a=new en(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=iV(t,n,r);if(!l.contains(i))throw new _(E.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);iP(e,i)||e.push(i)}a=new en(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iI(new eb(u),a,o)})(ik(i),"setDoc",e._key,s,null!==e.converter,r).toMutation(e._key,tT.none())])}function iW(e,t,r,...n){e=is(e,iu);let i=is(e.firestore,im),s=ik(i);return iY(i,[("string"==typeof(t=(0,l.m9)(t))||t instanceof iv?function(e,t,r,n,i,s){let a=e.pu(1,t,r),o=[iV(t,n,r)],u=[i];if(s.length%2!=0)throw new _(E.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iV(t,s[e])),u.push(s[e+1]);let h=[],c=eb.empty();for(let e=o.length-1;e>=0;--e)if(!iP(h,o[e])){let t=o[e],r=u[e];r=(0,l.m9)(r);let n=a.Ru(t);if(r instanceof ib)h.push(t);else{let e=iD(r,n);null!=e&&(h.push(t),c.set(t,e))}}return new iC(c,new en(h),a.fieldTransforms)}(s,"updateDoc",e._key,t,r,n):function(e,t,r,n){let i=e.pu(1,t,r);iL("Data must be an object, but it was:",i,n);let s=[],a=eb.empty();return Y(n,(e,n)=>{let o=iM(t,e,r);n=(0,l.m9)(n);let u=i.Ru(o);if(n instanceof ib)s.push(o);else{let e=iD(n,u);null!=e&&(s.push(o),a.set(o,e))}}),new iC(a,new en(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tT.exists(!0))])}function iY(e,t){return function(e,t){let r=new T;return e.asyncQueue.enqueueAndForget(async()=>nq(await n6(e).then(e=>e.syncEngine),t,r)),r.promise}(ip(e),t)}new WeakMap,function(e=!0){d=s.Jn,(0,s.Xd)(new a.wA("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new im(new A(t.getProvider("auth-internal")),new D(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new _(E.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new em(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),(0,s.KN)(h,"4.4.0",void 0),(0,s.KN)(h,"4.4.0","esm2017")}()}}]);